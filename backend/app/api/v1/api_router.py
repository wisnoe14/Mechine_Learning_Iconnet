...
from fastapi import APIRouter
from app.api.v1.endpoints import chat, conversation, login, check, predict
...
api_router.include_router(predict.router, prefix="/predict", tags=["Predict"])  # ⬅ ini yang ditambah
